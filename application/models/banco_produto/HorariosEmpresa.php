...
class HorariosEmpresa extends CI_Model{
    ...
    public function alteraHorarioAtendimento($horario){
        ...
        $this->db->where('empresa_horario_atendimento', $horario['empresa_horario_atendimento']);
        $this->db->set($horario);
    ...
    public function consultaHorarioAtendimento($pizzaria){
        ...
        $this->db->where('empresa_horario_atendimento', $pizzaria);
...
// controler horario ESPECIAL @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@    
    ...
    public function consultaHorarioEspecial($pizzaria){
        $this->db->where('empresa_horario_especial', $pizzaria['codigo_empresa']);
    ...
    public function removerHorarioEspecial($codigo, $pizzaria){
        ...
        $this->db->where('empresa_horario_especial', $pizzaria);
        $this->db->where('ativo_horario_especial', 1);
        ...
        $this->db->where('empresa_horario_especial', $especial["empresa_horario_especial"]);
        $this->db->where('ativo_horario_especial', 1);
    ...
    public function alteraHorarioEspecial($horario){
        ...
        $this->db->where('empresa_horario_especial', $horario['empresa_horario_especial']);
        $this->db->set($horario);
