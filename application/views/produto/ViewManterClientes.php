                ...
                <div class="row">
                    ...
                    <div class="sorter"><h6 style="display: inline-block;">Ordenar por: </h6>
                        <a  ng-class="{'activetab  waves-light' : predicate == 'nome_cliente',  'disabled': predicate != 'nome_cliente'}"
                            ng-click="predicate = 'nome_cliente'; reverse = !reverse" class="btn">Nome
                        ...
                        <a  ng-class="{'activetab  waves-light' : predicate == 'ativo_cliente',  'disabled': predicate != 'ativo_cliente'}"
                            ng-click="predicate = 'ativo_cliente'; reverse = !reverse" class="btn">Status
                            <i ng-show="predicate == 'ativo_cliente' && !reverse" class="material-icons right">expand_more</i>
                            <i ng-show="predicate == 'ativo_cliente' && reverse" class="material-icons right">expand_less</i>
                        </a>
                    </div>
                    ...
                    <table class="table hoverable bordered">
                        <thead>
                            <tr>                                                                
                                ...
                                <th ng-class="{'activetab waves-effect waves-light' : predicate == 'ativo_cliente'}"  ng-click="predicate = 'ativo_cliente';
                        ...
                        <tbody>
                            <tr dir-paginate="produto in produtos | filter:search:buscaSemAcento | filter:filters | orderBy:predicate:reverse:localeSensitiveComparator | itemsPerPage: resultlimit ">                                                              
                                ...
                                <td > {{produto.ativo_cliente}}</td>
                                <td class="text-align-center">
                                    <a ng-click="carregarProduto(produto.codigo_cliente)" title="alterar cliente" class="waves-light btn customAction" ><i class="material-icons centered">edit</i></a>
                                    <a ng-click="bloquearCliente(produto.codigo_cliente)" title="bloquear cliente" class="waves-light btn customAction" ng-if="produto.ativo_cliente == 'Ativo'"><i class="material-icons centered">block</i></a>
                                    <a ng-click="desbloquearCliente(produto.codigo_cliente)" title="desbloquear cliente" class="waves-light btn customAction" ng-if="produto.ativo_cliente == 'Bloqueado'"><i class="material-icons centered">lock_open</i></a>
                                </td>    
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s6">
                                    <input disabled="true" readonly="true" disabled="true" type="text" ng-model="ativo_cliente" name="ativo_cliente" id="ativo_cliente"  placeholder="Status"/>
                                    <label for="ativo_cliente">Status</label>
                                </div>
                                <div class="input-field col s6" >
                                    <input type="text" cpf-Input ng-model="cpf_cliente" name="cpf_cliente" id="cpf_cliente"  placeholder="000.000.000-00"/>
                                    <label for="cpf_cliente">CPF</label>
                                </div>
                                <div class="input-field col s12">
                                    <input type="email" ng-model="email_cliente" name="email_cliente" id="email_cliente"  placeholder="cliente@email.com"/>
                                    <label for="email_cliente">Email</label>                            
                                </div>

                                <div class="input-field col s12">
                                    <textarea class="materialize-textarea" type="text" ng-model="endereco_cliente" name="endereco_cliente" id="endereco_cliente" required aria-required="true" ng-pattern="/^([0-9,.'-()]+)?/" placeholder="Endereço do cliente"></textarea>
                                    <label for="endereco_cliente">Endereço</label>
                                    <div ng-if="produtoForm.endereco_cliente.$error.required && produtoForm.endereco_cliente.$dirty" style="color:red">Campo obrigatório.</div>
                                </div>
                                <div class="col s6">
                                ...
                                <div class="col s6">
                                    ...
                                    <input type="text" cep-input ng-model="cep_cliente" name="cep_cliente" id="cep_cliente"  ng-pattern="/^([0-9,.'-()]+)?/" placeholder="Cep do cliente"/>
                                ...
                                <div class="col s6">
                                    <label for="referencia_endereco_cliente">Ponto de referência</label>
                                    <input type="text" ng-model="referencia_endereco_cliente" name="referencia_endereco_cliente" id="referencia_endereco_cliente"  placeholder="Referência do endereço"/>

                                </div>
                                <div class="col s6">
                                    <label  for="telefone_cliente">Telefone</label>
                                    <input  type="text" ng-model="telefone_cliente" phone-input id="telefone_cliente" required aria-required="true"  placeholder="(00) 0000-0000"/>
                                    
                                    <div ng-if="produtoForm.telefone_cliente.$error.required && produtoForm.telefone_cliente.$dirty" style="color:red">Campo obrigatório.</div>
                                </div>
                                        ...
                                        app.controller('ControladorProduto', function ($scope, $http) {
                                            ...
                                            $scope.carregarProduto = function (id) {
                                                ...
                                                $http.post('<?= base_url("index.php/ControladorCliente/buscarClientesPorCodigo") ?>', {
                                                    ...
                                                    $scope.descricaoInput = data["nome_cliente"];
                                                    $scope.cpf_cliente = data["cpf_cliente"];
                                                    if ($scope.cpf_cliente != null) {
                                                        document.getElementById("cpf_cliente").disabled = true;
                                                    } else {
                                                        document.getElementById("cpf_cliente").disabled = false;
                                                    }
                                                    $scope.email_cliente = data["email_cliente"];
                                                    $scope.telefone_cliente = data["telefone_cliente"];
                                                    $scope.cep_cliente = data["cep_cliente"];
                                                    $scope.endereco_cliente = data["endereco_cliente"];
                                                    $scope.cidade_cliente = data["cidade_cliente"];
                                                    $scope.uf_cliente = data["uf_cliente"];
                                                    $scope.bairro_cliente = data["bairro_cliente"];
                                                    $scope.complemento_endereco_cliente = data["complemento_endereco_cliente"];
                                                    $scope.referencia_endereco_cliente = data["referencia_endereco_cliente"];
                                                    $scope.ativo_cliente = data["ativo_cliente"];
                                                    if ($scope.ativo_cliente != null) {
                                                        document.getElementById("ativo_cliente").disabled = true;
                                                    } else {
                                                        document.getElementById("ativo_cliente").disabled = false;
                                                    }
                                                    //   $scope.cidade_cliente = data["cidade_cliente"];
                                                    //   $scope.uf_cliente = data["uf_cliente"];
                                                    //   $scope.sexo_cliente = data["sexo_cliente"];                       
                                                    //   $scope.bairro_cliente = data["bairro_cliente"];
                                            ...
                                            $scope.alterarProduto = function () {
                                                $http.post('<?= base_url("index.php/ControladorCliente/confirmarAlterarClientes") ?>', {
                                                    ...
                                                    "nome_cliente": $scope.descricaoInput,

                                                    "email_cliente": $scope.email_cliente,
                                                    "telefone_cliente": $scope.telefone_cliente,
                                                    "cep_cliente": $scope.cep_cliente,
                                                    "endereco_cliente": $scope.endereco_cliente,
                                                    "complemento_endereco_cliente": $scope.complemento_endereco_cliente,
                                                    "referencia_endereco_cliente": $scope.referencia_endereco_cliente,
                                                    //   "cidade_cliente" : $scope.cidade_cliente,
                                                    //   "uf_cliente" : $scope.uf_cliente,
                                                    // "sexo_cliente" : $scope.sexo_cliente,

                                                    //"bairro_cliente" : $scope.bairro_cliente
                                                    ...
                                                    for (numero = 0; numero < $scope.produtos.length; numero++) {
                                                        if ($scope.produtos[numero].codigo_cliente === $scope.codigo_cliente) {
                                                            $scope.produtos[numero].nome_cliente = $scope.descricaoInput;
                                                            $scope.produtos[numero].cpf_cliente = $scope.cpf_cliente;
                                                            $scope.produtos[numero].email_cliente = $scope.email_cliente;
                                                            $scope.produtos[numero].telefone_cliente = $scope.telefone_cliente;
                                                            $scope.produtos[numero].cep_cliente = $scope.cep_cliente;
                                                            $scope.produtos[numero].endereco_cliente = $scope.endereco_cliente;
                                                            $scope.produtos[numero].complemento_endereco_cliente = $scope.complemento_endereco_cliente;
                                                            $scope.produtos[numero].referencia_endereco_cliente = $scope.referencia_endereco_cliente;
                                                        }
                                            ...
                                            $scope.bloquearCliente = function (codigo) {
                                                if (confirm("O status do cliente será alterado para BLOQUEADO e o cliente não poderá mais fazer pedidos pelo Messenger. Deseja confirmar?")) {
                                                    $http.post('<?= base_url("index.php/ControladorCliente/confirmarBloquearClientes") ?>', {
                                                        ...
                                                        for (numero = 0; numero < $scope.produtos.length; numero++) {
                                                            if (parseInt($scope.produtos[numero].codigo_cliente) === parseInt(codigo)) {
                                                                $scope.produtos[numero].ativo_cliente = "Bloqueado";
                                            ...
                                            $scope.desbloquearCliente = function (codigo) {
                                                if (confirm("O status do cliente será alterado para ATIVO e o cliente voltará a poder fazer pedidos pelo Messenger. Deseja confirmar?")) {
                                                    $http.post('<?= base_url("index.php/ControladorCliente/confirmarDesbloquearCliente") ?>', {
                                                        ...
                                                        for (numero = 0; numero < $scope.produtos.length; numero++) {
                                                            if (parseInt($scope.produtos[numero].codigo_cliente) === parseInt(codigo)) {
                                                                $scope.produtos[numero].ativo_cliente = "Ativo";
                                                                // $scope.produtos.splice(numero, 1);
                                                            }
                                                        }
                                                    }).error(function (response) {
