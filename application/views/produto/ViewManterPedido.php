            ...
            <div class="container main2" ng-app="myApp" ng-controller="listaPedidos">
                <div class="row">
                    <div class="col s12" ng-submit="entrar()" event-focus="submit">
                        ...
                        <h6>Atualização em <span ng-bind="chat.getContador()"></span> segundos.</h6><br>
                                    ...
                                    <table >
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="color: #9e9e9e;font-size: 0.8rem;font-weight:normal;">Preço unitário </th>
                                                <th style="color: #9e9e9e;font-size: 0.8rem;font-weight:normal;" >Preço total</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="input-field col s12">
                                        ...
                                        <div ng-if="tempoParada.minutos.$error.required && tempoParada.minutos.$dirty" style="color:red">Campo obrigatório.</div> 
                                        </p>
                                    </div>
                        ...
                        <form name="tempoAtiva" id="modal-ativa-form" class="modal" novalidate>
                            <div class="modal-content">
                                <h4 id="modal-produto-title">Deseja cancelar último pause?</h4>
                                <div class="row">  
                                    <div class="input-field col s12 center">
    ...
    function printTextArea(impressao) {
         ...
         for(var i = 0; i < impressao.length; i++){
             if(tudo == ""){
                ...
                tudo = tudo+"<br><br><br><br>"+impressao[i];
            }
         }
	 childWindow = window.open('','childWindow','location=yes, menubar=yes, toolbar=yes');
         childWindow.document.open();
	 childWindow.document.write('<html><head></head><body style="font: 1rem Lucida Console">');
    ...
    app.controller('listaPedidos', function ($scope, $http, ChatFactory) {
        ...
        $scope.alterarProduto = function () {
            ...
            $http.post('<?= base_url("index.php/ControladorManterPedidos/atenderPedidoAvisaCliente") ?>', {
                ...
                Materialize.toast("Erro ao comunicar o início do atendimento do pedido ao cliente", 8000);
                return "";
            });
            if($scope.impressao != null){
                printTextArea($scope.impressao);
        ...
        $scope.pausarChatBot = function () {
            if (confirm("Tem certeza que deseja pausar o bot por " + $scope.minutos + " minutos? Novos pedidos só chegarão caso você reinicie o ChatBot novamente ou o tempo pausado tenha terminado.")) {
