        ...
        <style>
            ...
            */
            ...
            (min-device-width: 768px) and (max-device-width: 1024px)  {
                ...
                Label the data
                */
                td:nth-of-type(1):before { content: "Bairro:"; font-weight: bold;}
                td:nth-of-type(2):before { content: "Preço:"; font-weight: bold;}
            }
                        ...
                        <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <select ng-model="selectedItem" material-select watch name="selectedItem" id="selectedItem" required 
...
//                    if(parseFloat($scope.produtos[numero].preco_taxa_entrega) === parseFloat($scope.precoEntrada)){
//                        Materialize.toast("É necessário alterar algum dado", 4000);
//                        return "";
//                    }
//                }
//
